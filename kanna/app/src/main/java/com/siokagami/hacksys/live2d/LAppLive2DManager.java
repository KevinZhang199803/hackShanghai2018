...
import com.siokagami.hacksys.activity.Live2dActivity;
import com.siokagami.hacksys.live2d.framework.jp.live2d.framework.L2DViewMatrix;
...
public class LAppLive2DManager
{
	...
	public void startRightMotion(){
		models.get(0).startMotion(LAppDefine.MOTION_GROUP_HARU_RIGHT,0,LAppDefine.PRIORITY_NORMAL);
	}

	public void startLeftMotion(){
		models.get(0).startMotion(LAppDefine.MOTION_GROUP_HARU_LEFT,0,LAppDefine.PRIORITY_NORMAL);
	}

	public void startShineMotion(){
