...
public class LAppDefine
{
	...
	//  モデル定義----------------------------------------------------------------------------------------------------
	public static final String MODEL_HIYORI = "live2d/hiyori/hiyori.model.json";
	...
	static final String MOTION_GROUP_HARU_RIGHT	="haru_right";	// 体をタップしたとき
	static final String MOTION_GROUP_HARU_LEFT	="haru_left";	// 体をタップしたとき
	static final String MOTION_GROUP_HARU_WEATHER	="haru_weather";	// 体をタップしたとき
